...
const CardLoop = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('http://localhost:8000/details/data?specialisation='+'Teacher'+'&avaialbility='+'Full Time'+'&location='+'India'+'&experience='+'0-5 years'); // Update the URL to your backend endpoint
        if (response.ok) {
